...
I believe that the cards are faster to implement using this framework, it took at most 20 minutes to figure out how to add them into the project. I think this would be difficult to figure out and make responsive in static html, and it wouldn't react the same as it currently is.
...
I changed the how it works section into a list group instead of the previously designed, It gave the list a cleaner, more professional impression and gives it the list appearance.
...
I didn't need to rebuild the navbar, as bootstrap provides plenty of options. I believe the framework is a better choice, as it allows you to change the design easily if the client prefers a different option.
